...
The emotion component handler make use of this service to increase the performance of loading an shopping world. Imagine you have three article boxes configured with topseller products of a category. Prior to 5.3, you will get the same product for each box. As of 5.3, you will get different topseller products.
